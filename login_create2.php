...
if ($connection) {
 ...
 // Creating Our Query
 /* user is a function btw, and 
 it is also always supposed to have the
  "name" attribute made in html in order to work*/

//the second "query" varaible should 
//have concactination this is really important
